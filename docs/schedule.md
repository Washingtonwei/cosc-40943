...
| 4 | Sep 14, 16, 18 | Requirements as the contract (2 of 2): use cases, business rules, quality attributes, the SRS<br>[Slides](slides/writing-the-specification.html){ .mat } [Reading](modules/spec-driven-requirements.md){ .mat } [Use case style guide](https://github.com/Washingtonwei/use-case-style-guide){ .mat } | Write your use cases and business rules; draft the SRS | Draft specification underway |
