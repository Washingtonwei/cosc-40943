...
|----|-------|-------------------|------------|-------------------|
| 1 | Aug 24, 26, 28 | Software engineering and what AI changes; the delegation boundary; a real failure story; the Napkin frame<br>[Story](slides/fifteen-weeks-to-demo-day.html){ .mat } [Slides](slides/se-and-ai.html){ .mat } [Reading](modules/se-and-ai.md){ .mat } | Onboarding: environment setup, run Project Pulse once, first AI-assisted task | Interest and skills survey, due Fri Aug 28 |
