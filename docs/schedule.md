...
| 2 | Aug 31, Sep 2, 4 | The AI-augmented team and GitHub as single source of truth; professionalism, team contract, conflict protocol<br>[Slides](slides/ai-augmented-team.html){ .mat } [Reading](modules/ai-augmented-team.md){ .mat } | Your team's first hour together: fix your meeting slot, sign the contract, stand up repo, board, and Slack. **Checkpoint 0** is verified in the room as you work. | Teams, clients, and project briefs released Wed Sep 2; contract signed, board and Slack up, first client meeting requested |
