...
| 6 | Sep 28, 30, Oct 2 | Software architecture, just enough: breadth-complete and depth-shallow, architecturally significant requirements, security as a quality attribute | **Checkpoint 1** to your TA. [Assignment 2](assignments/spec-a-feature.md) is due the same morning, before class. | Specification reviewed; architecture-of-record drafted |
