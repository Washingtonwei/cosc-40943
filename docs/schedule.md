...
| 5 | Sep 21, 23, 25 | Context engineering: the specification is the context, and when is it enough. Napkin **round 1** opens Wednesday<br>[Slides](slides/context-engineering.html){ .mat } [Reading](modules/context-engineering.md){ .mat } | Week 4's team work checked by your TA, then turn your riskiest use cases into agent build-contexts, in pairs, and run the questions test on them<br>[Studio](studio.md#week-5-sep-25-your-first-build-context){ .mat } | Draft specification validated against build-contexts |
