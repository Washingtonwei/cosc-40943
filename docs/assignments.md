...
Each is due about three weeks after the last, on the Friday of the week its topic is taught or the Friday after it. That Friday's [studio](studio.md) then applies the same move to your team's project, so you do it once alone on Project Pulse and once with your team on your own code, in that order. Plan accordingly: Monday and Wednesday lecture is what you have behind you when the individual version is due. None lands during a break. Two share a Friday with a checkpoint, and both are deliberate: Checkpoint 0 is a lightweight kickoff gate and assignment 1 is small, and assignment 2 is submitted to TCU Online before class while Checkpoint 1 is presented in that day's studio, so they overlap in your week but not in the room.
